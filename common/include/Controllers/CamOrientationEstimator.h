/*! @file CamOrientationEstimator.h
 *  @brief All CamOrientation Estimation Algorithms
 *
 ...
 *  - rpy: roll pitch yaw
 */
#ifndef PROJECT_CAMORIENTATIONESTIMATOR_H
#define PROJECT_CAMORIENTATIONESTIMATOR_H
 ...
 */
template <typename T>
class CamVectorNavOrientationEstimator : public GenericEstimator<T> {
 public:
  virtual void run();
  virtual void setup() {}
