...
/*!
 * Configure the window for displaying biqu
 */
size_t Graphics3D::setupBiQu(Vec4<float> color, bool useOld, bool canHide) { return _drawList.addBiQu(color, useOld, canHide); }
